...
export namespace test
{
	...
	inline constexpr auto _memory_range_delegate_ = atma::functor_list_t
	{
		...
		[](auto const& operation, atma::dest_memory_concept auto&& dest, atma::src_memory_concept auto&& src, size_t sz)
		{
		...
		[](auto const& operation, atma::dest_bounded_memory_concept auto&& dest, atma::src_bounded_memory_concept auto&& src)
		{
		...
		[](auto const& operation, atma::dest_bounded_memory_concept auto&& dest, atma::src_memory_concept auto&& src)
		{
			operation(
				atma::get_allocator(dest),
				atma::get_allocator(src),
	...
	//	{ return ::test::_memory_range_delegate_<decltype(::test::_memory_copy_)>(std::forward<decltype(args)>(args)...); };
