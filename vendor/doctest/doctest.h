...
#define DOCTEST_DEFINE_DECORATOR(name, type, def)                                                  \
    ...
    {                                                                                              \
		...
		detail::TestCase& operator* (detail::TestCase& tc) { fill(tc); return tc; }                \
		detail::TestSuite& operator* (detail::TestSuite& ts) { fill(ts); return ts; }              \
    }
